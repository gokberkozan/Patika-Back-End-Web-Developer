package dev.patika.restapi.v1.api;

import dev.patika.restapi.v1.business.abstracts.BookBorrowingService;
import dev.patika.restapi.v1.core.config.modelMapper.ModelMapperService;
import dev.patika.restapi.v1.core.result.Result;
import dev.patika.restapi.v1.core.result.ResultData;
import dev.patika.restapi.v1.core.utils.ResultHelper;
import dev.patika.restapi.v1.dto.request.book.BookSaveRequest;
import dev.patika.restapi.v1.dto.request.bookBorrowing.BookBorrowingUpdateRequest;
import dev.patika.restapi.v1.dto.response.CursorResponse;
import dev.patika.restapi.v1.dto.response.bookBorrowing.BookBorrowingResponse;
import dev.patika.restapi.v1.entites.BookBorrowing;
